...
public class LoggedInAsTeacherLoop {
    public static void loop(Scanner scnr, TeacherAccount user) {
        ...
        while (!exit) {
            ...
            System.out.println("Options: view_students | create_assignment | create_course | edit_grade | add_student | remove_student | exit");
            ...
            else if (getChoice.equalsIgnoreCase("create_course")) {
